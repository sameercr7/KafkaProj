...
function populateTable(data) {
    const table = document.getElementById('trackingLettersForDep');
    const heading = document.getElementById('trackingLettersForDepHeading');
    ...
    data.forEach((item, index) => {
        ...
        viewButton.className = 'btn btn-primary text-decoration-none'; // Bootstrap classes for button styling
