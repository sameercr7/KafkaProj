            ...
            .then(response => {
                ...
                agencyTableData.forEach(item => {
                    ...
                    row.innerHTML = `
                        ...
                        <td>${item.date || 'N/A'}</td>
                        <td>
                            <a href="/noc/flowcharttable?id=${item.application_id}" >
                        ...
                        <td>
                         <a href="/noc/flowchart?id=${item.application_id}" >
                                <button class="btn btn-light">
                                    <span> <img class="img card-logo" src="/img/flowchart.png" alt="rejected"></span>
                                </button>
                            </a>
</td>
                        <td>
                                     <a href="/noc/viewOnlyApplication?id=${item.id}" >
